pipeline {
    ...
    parameters {
        ...
        string description: '发版服务器IP', name: 'SERVER_IP', defaultValue: '10.10.1.2'
        ...
        string description: '加锁资源', name: "LOCK_RESOURCE", defaultValue: 'server-10-10-1-2'
    }
    ...
    environment {
        ...
        dockerRepoIpPort = "10.10.1.1:8081"
